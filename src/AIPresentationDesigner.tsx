...
export default function AIPresentationDesigner() {
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.2fr 0.8fr", gap: "4rem" }}>
          <div style={{ animation: "fadeInUp 1s ease-out 0.2s backwards" }}>
            ...
            <p style={{ fontSize: "20px", color: "#89cff0", margin: "0 0 3rem 0", fontWeight: 400, letterSpacing: "0.05em" }}>
              AI turns content into on-brand presentations.
            </p>

            <section style={{ marginBottom: "2.5rem" }}>
              <p style={{ fontSize: "16px", color: "#e2e2e2", lineHeight: 1.6, fontWeight: 300 }}>
                We’re exploring what happens when design communication is treated as a system, not a final step. 
              </p>
            </section>

            <section style={{ marginBottom: "2.5rem" }}>
              <p style={{ fontSize: "16px", color: "#e2e2e2", lineHeight: 1.6, fontWeight: 300 }}>
                Much of design impact depends on how clearly ideas are packaged and shared. This layer is often manual, repetitive, and shaped by scattered brand rules. It slows down how quickly work can be understood, adapted, and scaled. 
              </p>
            </section>

            <section style={{ marginBottom: "2.5rem" }}>
              <p style={{ fontSize: "16px", color: "#e2e2e2", lineHeight: 1.6, fontWeight: 300 }}>
                As part of our innovation lab, we built an experimental AI design tool through rapid “vibe coding”. The tool takes in raw presentations in PPT or PDF format and reinterprets them through different visual and narrative lenses. It can map content to structured templates aligned with brand guidelines, or generate entirely new directions based on a desired mood or aesthetic. 
              </p>
            </section>

            <section style={{ marginBottom: "2.5rem" }}>
              <p style={{ fontSize: "16px", color: "#e2e2e2", lineHeight: 1.6, fontWeight: 300 }}>
                This is less about automating slides and more about testing a shift. Can design thinking be translated, restructured, and re-skinned in real time while still retaining intent? Can communication become fluid without losing consistency? 
              </p>
            </section>
            ...
            <section style={{ 
              ...
              <p style={{ fontSize: "18px", color: "#ffffff", lineHeight: 1.5, fontWeight: 400, fontStyle: "italic", margin: 0 }}>
                The tool is an early prototype towards that idea. 
              </p>
            </section>
          </div>
          <div style={{ position: "relative", animation: "fadeInUp 1.2s ease-out 0.4s backwards" }}>
             <div style={{
               ...
               <img src="/AAI PRESENTATION DESIGNER.png" alt="AI Presentation Designer" style={{ width: "100%", height: "auto", display: "block" }} />
               <div style={{
                 position: "absolute",
                 inset: 0,
